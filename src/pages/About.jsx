      ...
      <div className='container mx-auto px-8 md:px-16 lg:px-24'>
        <div className='flex flex-col md:flex-row items-center md:space-x-12'>
          ...
          <div className='flex-1'>
            ...
            I am a Possionate Beginner developer with focus on building 
            modern and responseive web applications. with a good knowledge foudation 
            in both front end and backend technologies, I strive to create 
         ...
         <div className='space-y-4'>
          ...
          <div className='flex items-center'>
            ...
            <div className=' grow bg-gray-800 rounded-full h-2.5'>
              <div className='bg-gradient-to-r from bg-green-400 to-blue-500 h-2.5 rounded-full transform transition-transform duration-300 hover:scale-105 w-11/12'>
              </div>
            </div>
          </div>
          <div className='flex items-center'>
            ...
            <div className=' grow bg-gray-800 rounded-full h-2.5'>
              <div className='bg-gradient-to-r from bg-green-400 to-blue-500 h-2.5 rounded-full   transform transition-transform duration-300 hover:scale-105 w-9/12'>
              </div>
            </div>
          </div>
         </div>
